...
#######################################################################
    ...
    def movies(self, lite=False):
        self.addDirectoryItem('Reviews and Trailers', 'movieReviews', 'reviews.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem('Reviews and Trailers', 'tvReviews', 'reviews.png', 'DefaultTVShows.png')
