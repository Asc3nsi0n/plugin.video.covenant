...
class movies:
    def __init__(self):
        ...
        if self.hidecinema == 'true':
            ...
            self.language_link = 'http://www.imdb.com/sech/title?title_type=feature,tv_movie&num_votes=100,&production_status=released&primary_language=%s&sort=moviemeter,asc&count=40&start=1'
