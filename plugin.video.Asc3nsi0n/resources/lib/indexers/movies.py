...
class movies:
    def __init__(self):
		...
		#CUSTOM
        self.xmastrakt_link = 'http://api.trakt.tv/users/benfranklin/lists/christmas-x-mas-holiday-movies/items'
        self.xmastrakt2_link = 'http://api.trakt.tv/users/urbanizedmoose/lists/christmas-movies/items'

        self.animation_link = 'http://api.trakt.tv/users/ksiciunas29/lists/kids-movies/items'	
    ...
    def search(self):
        ...
        navigator.navigator().endDirectory(file=True)        
    ...
    def genres(self):
        ...
        self.addDirectory(self.list, file=True)
        return self.list
    ...
    def years(self):
        ...
        for i in range(int(year)-0, 1900, -1): self.list.append({'name': str(i), 'url': self.year_link % (str(i), str(i)), 'image': 'calendar.png', 'action': 'movies'})
        self.addDirectory(self.list, file=True)
        return self.list
    ...
    def addDirectory(self, items, queue=False, file=False):
		if items == None or len(items) == 0: control.idle() ; sys.exit()
