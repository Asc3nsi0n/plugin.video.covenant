...
addon_id = 'plugin.video.Asc3nsi0n'								   
...
class indexer:
    ...
    def root(self):
        try:
            regex.clear()
            url = 'http://cbox-files.s3.amazonaws.com/ascension/xml-4.0/Home.xml'
    ...
    def addDirectory(self, items, queue=False):
        ...
        if mode in ['movies', 'tvshows', 'seasons']:
            views.setView('tvshows', {'skin.estuary': 55, 'skin.confluence': 500, 'skin.tvOS-X-krypton': 53})
        if mode in ['episodes']:
            views.setView(mode, {'skin.estuary': 55, 'skin.confluence': 504, 'skin.tvOS-X-krypton': 50})
