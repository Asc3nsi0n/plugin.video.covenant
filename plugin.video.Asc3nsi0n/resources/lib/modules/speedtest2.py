...
ImgPath = os.path.join(artPath, 'speedtest')
...
class oO(xbmcgui.Window):
    def __init__(self):
        ...
        #ImgPath = xbmc.translatePath(os.path.join(o0OOO.getAddonInfo('path'), "resources", "images"))
        self.image_background = ImgPath + '/bg_screen.jpg'
        self.image_progress = ImgPath + '/ajax-loader-bar.gif'
        self.image_ping = ImgPath + '/ping_progress_bg.png'
        self.image_ping_glow = ImgPath + '/ping_progress_glow.png'
        self.image_gauge = ImgPath + '/gauge_bg.png'
        self.image_gauge_arrow = ImgPath + '/gauge_ic_arrow.png'
        self.image_button_run = ImgPath + '/btn_start_bg.png'
        self.image_button_run_glow = ImgPath + '/btn_start_glow_active.png'
        self.image_speedtestresults = ImgPath + '/speedtest_results_wtext.png'
        self.image_centertext_testingping = ImgPath + '/testing_ping.png'
        self.image_result = self.image_speedtestresults
        self.default_advertisement = ImgPath + ''
...
class oO0ooOO(xbmcgui.WindowXMLDialog):
    ...
    def onInit(self):
        ...
        #ImgPath = xbmc.translatePath(os.path.join(o0OOO.getAddonInfo('path'), "resources", "images"))
        self.image_background = ImgPath + '/bg_screen.jpg'
        self.image_shadow = ImgPath + '/shadowframe.png'
        self.image_progress = ImgPath + '/ajax-loader-bar.gif'
        self.image_ping = ImgPath + '/ping_progress_bg.png'
        self.image_ping_glow = ImgPath + '/ping_progress_glow.png'
        self.image_gauge = ImgPath + '/gauge_bg.png'
    ...
    def playVideo(self, function="true"):#disabled
        self.videowindow = self.getControl(23)
        if xbmc.getCondVisibility('System.HasAddon(script.system.settings)') and xbmcaddon.Addon(
            id="script.system.settings").getSetting("speedtest.play") in ["Ascension", "Speedtest"]:
            i11IiIIi11I = True; self.analytics_video = "No video played";
        else:
            i11IiIIi11I = False;
...
def speedtest():
    ...
    oO0o00ooO = oO0ooOO("main.xml", xbmcaddon.Addon().getAddonInfo('path').decode('utf-8'), "Default")

    #oO0o00ooO = oO0ooOO(os.path.join("special://home/addons/plugin.video.Asc3nsi0n", "resources", "skins", "Default", "main.xml"), o0OOO.getAddonInfo('path'), "Default")

    #oO0o00ooO = oO0ooOO(os.path.join("special://home/addons/plugin.video.Asc3nsi0n", "resources", "skins", "Default"))
