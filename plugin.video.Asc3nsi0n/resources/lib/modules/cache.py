...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Ascension Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.Asc3nsi0n')
    ...
    try:
        curVersion = control.addon('plugin.video.Asc3nsi0n').getAddonInfo('version')
