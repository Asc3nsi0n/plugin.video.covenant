...
def _pbhook(numblocks, blocksize, filesize, dp, start_time):
        try: 
            ...
            mbs = '[COLOR red]%.02f MB[/COLOR] of %.02f MB' % (currently_downloaded, total)
            e = 'Speed: [COLOR red]%.02f Mb/s ' % mbps_speed  + '[/COLOR]'
            e += 'ETA: [COLOR red]%02d:%02d' % divmod(eta, 60) + '[/COLOR]'
        ...
        if dp.iscanceled():
            ...
            dialog.ok("Ascension", 'The download was cancelled.')
